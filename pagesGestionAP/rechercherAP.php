                 ...
                 <td class="informations">
                    ...
                    <form class="form-inline" role="form" action="rechercherAPResultat.php" method="POST">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="groupeA" size="3" placeholder="192">
                           <strong>.</strong>
                            <input type="text" class="form-control" id="groupeB" size="3" placeholder="168">
                            <strong>.</strong>
                           <input type="text" class="form-control" id="groupeC" size="3" placeholder="1">
                           <strong>.</strong>
                           <input type="text" class="form-control" id="groupeD" size="3" placeholder="0">
                           <strong>/</strong>
                           <input type="text" class="form-control" id="masque" size="2" placeholder="24">                               
