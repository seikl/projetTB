              ...
              <tr>
                 ...
                 <td class="informations">                     
                    <ol class="breadcrumb">
                        ...
                        <li><a href="ajoutModifModele.php">Ajouter un mod&egrave;le d'AP</a></li>
                   ...
                   <ol>
                        <?php
                            ...
                            if ($_POST) {                            
                                ...
                                $boutonReinit = '<button class="btn btn-default" onclick="window.location.href = \'ajoutModifModele.php\'">R&eacute;initialiser le formulaire</button>';
                            ...
                            else {echo " <strong>Aucune information reçue. Veuillez remplir le formulaire d'ajout.</strong><br>";}
