 ...
 * 
 * Description:
 * page d'enregistrement des modification d'une ligne de commande avec les informations reçues depuis "ajoutCLI.php"
 * 
 * Paramètres reçus:
                 ...
                 <td class="informations">                     
                   ...
                   <ol>
                        <?php
                            ...
                            $boutonReinit = '<button class="btn btn-default" onclick="window.location.href = \'selectModifCLI.php\'">Revenir &agrave; la s&eacute;leciton</button>';
                            ...
                            if ($_POST) {    
                                ...
                                {                            
                                    ...
                                    if ((isset($_POST['choixTypeCommande'])) && ($choixAjoutDescription == 'selection') && $reqEnregistrement){                                                                                 
                                        $reqEnregistrement = $connexion->query("UPDATE ".$PARAM_nom_bd.".lignesCommande SET ligneCommande='".$ligneCommande."',protocole='".$protocole."',portProtocole='".$portProtocole."',noModeleAP='".$modeleAP["noModeleAP"]."',notypeCommande='".$notypeCommande."' WHERE noCLI='".$noCLI."';");
                                    }
                                    ...
                                    echo "<tr><td>No de la ligne de commande:&nbsp;</td><td>".$noCLI."</td></tr>";
                                    ...
                                    if (!$reqEnregistrement){                                                                                                                        
                                        echo "<br><p><strong> Probl&egrave;me lors de la modification</strong>!<br><br>";                                        
                                        echo $boutonRetour."&nbsp;&nbsp;&nbsp;&nbsp;".$boutonReinit."</p>";
                                    }
                                    else{
                                        echo "<p><strong> Modfication effect&eacute; avec succ&egrave;s</strong>!<br>";
